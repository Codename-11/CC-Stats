...
- feat: analytics live data refresh on poll completion (Story 13.9) (#99)
- fix: poll interval hot reload (Story 2.5) (#98)

## [1.4.7] - 2026-03-05

### Changed

- fix: shorten rate limit message to fit popover panel (#97)

## [1.4.6] - 2026-03-05

### Changed

- feat: rate limit retry with exponential backoff (Story 2.4) (#96)

## [1.4.5] - 2026-03-04

### Changed

- feat: API outage background rendering in analytics charts (Story 13.8) (#95)
- feat: API outage period tracking and persistence (Story 10.6) (#94)
- feat: API connectivity notifications with outage/recovery state machine (Story 5.4) (#93)
- feat: clickable ring gauges as analytics launchers (Story 4.6) (#92)
- feat: first-run onboarding popup, README rewrite, app icon (#91)

## [1.4.4] - 2026-02-26

### Changed

- fix: changelog generation uses wrong git log range, producing empty entries (#90)
...
[1.4.5]: https://github.com/rajish/cc-hdrm/compare/v1.4.4...v1.4.5
[1.4.4]: https://github.com/rajish/cc-hdrm/compare/v1.4.3...v1.4.4
[1.4.3]: https://github.com/rajish/cc-hdrm/compare/v1.4.2...v1.4.3
[1.4.2]: https://github.com/rajish/cc-hdrm/compare/v1.4.1...v1.4.2
[1.4.1]: https://github.com/rajish/cc-hdrm/compare/v1.4.0...v1.4.1
[1.4.0]: https://github.com/rajish/cc-hdrm/compare/v1.3.2...v1.4.0
[1.3.2]: https://github.com/rajish/cc-hdrm/compare/v1.3.1...v1.3.2
