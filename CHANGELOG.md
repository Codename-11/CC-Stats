...
### Fixed
- **Toast text wrapping** -- long toast messages now wrap properly instead of overflowing the window edge. Uses Grid layout with constrained width (MaxWidth=288) so TextWrapping takes effect.
